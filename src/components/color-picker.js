...
module.exports = AFRAME.registerComponent('ui-color-picker', {
    ...
    init() {
        ...
        this.el.open = ()=>{
            ...
            this.tweenPickerScale(0.00001,1);
        };
        this.el.close = ()=>{
            this.tweenPickerScale(1,0.00001)
    ...
    setupBacking(){
        ...
        buttonConfirm.className = 'intersect';
        ...
        buttonConfirm.addEventListener('mousedown',()=> {
            let hex = this.getHex();
        ...
        buttonCancel.className = 'intersect';
    ...
    setupColorWheel(){
        ...
        this.colorWheel.className = 'intersect';
    ...
    setupBrightnessSlider(){
        ...
        this.brightnessSlider.className = 'intersect';
        ...
        brightnessResetLeft.className = 'intersect';
        ...
        brightnessResetRight.className = 'intersect';
