 ...
 */
module.exports.Component = AFRAME.registerComponent('expanse-portal', {
    schema: {
        spaces_id:{default: '1',},
    ...
    initVisualAspect: function () {
        ...
        textEl.setAttribute('position', '0 3.5 0');
        ...
        return function () {
            ...
            if ( distance < 1 && !this.triggered ) {
                ...
                if (distance < 0.5) {
                    ...
                    textEl.setAttribute('position', '0 2.5 0');
                    el.getObject3D('mesh').visible = true;
...
/* eslint-disable */
AFRAME.registerShader('expanse-portal', {
    schema: {
    ...
    fragmentShader: [
        ...
        'vec2 sampleUV;',
        'float borderThickness = clamp(exp(-vDistance / 50.0), 0.9, 1.0);',
